...
QUnit.test("7-Eleven am", function (assert) { runTest(assert, 7, 11, 9) });
...
QUnit.test("420 am", function (assert) { runTest(assert, 4, 20, 0) });
QUnit.test("420 pm", function (assert) { runTest(assert, 16, 20, 7) });
...
QUnit.test("Beer o'clock am", function (assert) { runTest(assert, 5, 0, 3) });
...
QUnit.test("What color is the sea", function (assert) { runTest(assert, 23, 37, 9) });
